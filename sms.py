...
def main():
    phone = str(input(Fore.GREEN + "\nCreated By iliya :) \n" + Fore.GREEN + "Help: (Github): https://github.com/imiliyapy \n\n" + Fore.WHITE + "  ... \n\n" + Fore.RED + "Please Turn On Tor \n" + Fore.RED + "Phone Number Target (+98912......) => "))
    while True:
